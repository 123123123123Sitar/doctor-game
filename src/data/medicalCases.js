...
export const getMedicalCases = (difficulty = 'medium') => [
    {
        ...
        requiredSequence: ['scan', 'iv', 'iv', 'oral'], // Scan -> IV (Dantrolene) x2, Oral (Cooling)
    ...
    },
    {
        ...
        requiredSequence: ['scan', 'injection_b', 'injection_b', 'oral'], // Scan -> Epi x2, Antihistamine
    ...
    },
    {
        ...
        requiredSequence: ['scan', 'oral', 'iv', 'injection_a'], // Scan -> Beta blocker, Fluids, Steroids
    ...
    },
    {
        ...
        requiredSequence: ['scan', 'injection_a', 'injection_a', 'oral'], // Scan -> Vit K x2, Plasma
    ...
    },
    {
        ...
        requiredSequence: ['scan', 'oral', 'oral', 'iv'], // Scan -> Oral x2 (Chelation), IV (Flush)
